  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Sammy Kimani</h1>
            <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I am a Front-End Web Developer</h2>
            <p className='text-[#8892b0] max-w-[700px]'>I am a Front-End web developer specializing in building excellent digital products. I am currently well-versed in building responsive web applications.</p>
            <div>
